    ...
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <div className="site-footer-columns">
          {/* JEWELSAFA Column with accordion */}
          <div className="site-footer-col">
            <button className="footer-col-toggle" onClick={() => toggleFooterCol('about')}>
              <h3 style={{ margin: 0 }}>JEWELSAFA</h3>
              <span className="footer-col-icon">{openFooterCol === 'about' ? '−' : '+'}</span>
            </button>
            <div className={`footer-col-links ${openFooterCol === 'about' ? 'open' : ''}`}>
              <p className="text-muted" style={{ margin: '0 0 1rem 0', lineHeight: '1.6' }}>
                Rings, necklaces, earrings, bracelets and bangles — curated for shine that lasts beyond the occasion.
              </p>
              <div className="site-footer-social-row" style={{ marginTop: '0.5rem' }}>
